          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-blue-50 p-4 rounded-lg shadow-md">
              <div className="flex items-center justify-center space-x-3">
                <p className="font-semibold">STM32L4S5</p>
              </div>
            </div>
            <div className="bg-purple-50 p-4 rounded-lg shadow-md">
              <div className="flex items-center justify-center space-x-3">
      ...
      content: (
        <div className="flex flex-col items-center justify-center h-full space-y-8">
          ...
          <div className="bg-blue-50 p-6 rounded-lg shadow-md text-center">
            ...
            {/* BOTÓN PARA EL KIT EDUCATIVO - EMPIEZA AQUÍ */}
            <a href="https://vicmiralo.github.io/kit-educativo/" target="_blank" rel="noopener noreferrer" className="bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-700 transition-all inline-block no-underline shadow-md">
              🎓 Ver Kit Educativo
            </a>
            {/* BOTÓN PARA EL KIT EDUCATIVO - TERMINA AQUÍ */}
          </div>
        </div>
      ),
    },
